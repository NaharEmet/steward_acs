...
audit_reasoning: "This is an exemplary skill. It is highly actionable with clear, numbered steps for canonical, local, and escape-hatch deployments. It includes comprehensive prerequisites, verification (smoke checks), and failure recovery (resume/rollback). The description is distinct and informative. The content is rich with concrete examples: exact file paths, command snippets, environment variable names, and tool references (GitHub Actions, Infisical, Docker Compose). The audience ('coding') is perfectly served by the technical depth and script references. It is unique among the existing skills, focusing on the deployment workflow rather than secrets, installation, or analytics. The scope is well-defined and matches the content."
audit_score: 10
audit_status: "ok"
audited_at: "2026-07-28T18:04:43.612504Z"
---
