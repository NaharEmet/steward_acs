...
audit_reasoning: "The skill is highly actionable with clear, numbered steps, concrete tool examples, and specific parameters. It includes prerequisites (clarifying artifact details), verification (confirming to user), and failure recovery. The description is distinct and informative. The audience fit is excellent, as it provides tool references for both chat and coding surfaces, which is appropriate for a skill tagged for 'coding' but covering both contexts. It is unique and not a duplicate of existing skills. Content depth is strong with exact tool names, path examples, and parameter structures."
audit_score: 10
audit_status: "ok"
audited_at: "2026-07-29T04:34:59.623341Z"
---
